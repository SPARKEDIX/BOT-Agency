...
- Real task (multi-step work, research + code + docs, deliverables, needs specialists): return {"type":"task","tasks":[{"id":1,"agent":"researcher|coder|coding|writer|reviewer|scraper|yt_scraper|lead_gen|marketing|url_data|image_maker","instruction":"..."}]} with 1-4 tasks.
Available agents: researcher, coder, coding, writer, reviewer, scraper, yt_scraper, lead_gen, marketing, url_data, image_maker (use scraper for any URL / fetch-website-content work, yt_scraper for YouTube channels/videos/search, lead_gen for find-leads/prospects/outreach lists, marketing for product-details/competitors/positioning, url_data for extract-table/JSON/structured-data-from-URL, coding for codegen/debugging/refactoring, image_maker for draw/generate-image/picture/photo/logo).
...
[{"id":1,"agent":"researcher|coder|coding|writer|reviewer|scraper|yt_scraper|lead_gen|marketing|url_data|image_maker","instruction":"..."}]
Available agents: researcher, coder, coding, writer, reviewer, scraper, yt_scraper, lead_gen, marketing, url_data, image_maker (URL / website-content work, yt_scraper for YouTube, lead_gen for leads, marketing for product/competitors, url_data for structured data, image_maker for images).
